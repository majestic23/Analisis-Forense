...
sudo dpkg -i tilix-common_1.8.9-1_all.deb
sudo dpkg -i libphobos2-ldc-shared82_1.12.0-1_amd64.deb
sudo dpkg -i libgtkd-3-0_3.8.5-1_amd64.deb
sudo dpkg -i libvted-3-0_3.8.5-1_amd64.deb
sudo dpkg -i tilix_1.8.9-1_amd64.deb
```
